...
## Project Overview
The project compares four training datasets with a set of predefined ideal functions to identify the best-fitting models. Test data points are assigned to ideal functions if they satisfy a deviation constraint derived from the training data.
